...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Optimization\Sequential\Data\Wojtanovic.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Optimization\Sequential\Data\Wojtanovic.FUNSMRY');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Optimization\Sequential\Data\Wojtanovic.RSM');
A=fscanf(fileID,'%c');
