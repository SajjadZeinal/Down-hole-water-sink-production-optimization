...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Optimization\Sequential\Data\Wojtanovic.data','r');
...
if WATER_DRAINAGE_WELL_COMPLETION_int == 15050 
    TOP_WATER_INJECTION_COMPLETION_HEIGHT = WATER_DRAINAGE_WELL_COMPLETION_int + 200 + 5;
else 
    TOP_WATER_INJECTION_COMPLETION_HEIGHT = WATER_DRAINAGE_WELL_COMPLETION_int + 200 ;
end
    N_DI_SPACING = 40;
    BLOCK_DI_SPACING_LENGTH = 200/N_DI_SPACING;
...
BOTTOM_WATER_INJECTION_HEIGHT = N_WATER*BLOCK_WATER + N_DIST*BLOCK_DIST + 50 + 15000; 
if BOTTOM_WATER_INJECTION_HEIGHT == 15550
    ...
    SCHEDULE_OUT(DZ_edit+294:DZ_edit+294+length(N_TOP_WATER_DRAINAGE_str)-1)=N_TOP_WATER_DRAINAGE_str;
    SCHEDULE_OUT(DZ_edit+299:DZ_edit+302)='    ';
    SCHEDULE_OUT(DZ_edit+299:DZ_edit+299+length(N_WATER_DRAINAGE_COMPLETION_str)-1)=N_WATER_DRAINAGE_COMPLETION_str;
    TOTAL_VERTICAL_BLOCK_int = N_WATER_DRAINAGE_COMPLETION;
else
  ...
  TOP_BELOW_WATER_INJ_int = N_WATER_DRAINAGE_COMPLETION + 1;
...
SCHEDULE_OUT(WELL_edit+147:WELL_edit+147+length(BELOW_OF_BOTTOM_OIL_ZONE_str)-1)=BELOW_OF_BOTTOM_OIL_ZONE_str;
SCHEDULE_OUT(WELL_edit+152:WELL_edit+154)='   ';
SCHEDULE_OUT(WELL_edit+152:WELL_edit+152+length( TOTAL_VERTICAL_BLOCK_str)-1)= TOTAL_VERTICAL_BLOCK_str;
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Optimization\Sequential\Data\Wojtanovic.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\Final\DWS\Optimization\Sequential\Data\Wojtanovic.data"');
