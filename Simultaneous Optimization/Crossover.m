...
if temp > 2
    ...
    if temp == 3
       ...
       if Individual(1,4) >= Individual(1,3) 
           Cross_Assistant(cross_count,:) = Individual;
           cross_count=cross_count-1;
       end
       if Individual2(1,4) >= Individual2(1,3) 
       ...
       if Individual3(1,4) >= Individual3(1,3) 
           Cross_Assistant(cross_count,:) = Individual3;
           cross_count=cross_count-1;
       end
       if Individual4(1,4) >= Individual4(1,3) 
       ...
       if Individual5(1,4) >= Individual5(1,3) 
