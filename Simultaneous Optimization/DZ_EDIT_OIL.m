function [  OIL_PERF , N_OIL_BLOCK , LOWER_OIL , N_LOWER_OIL  ] = DZ_EDIT_OIL( x4 , x3 )
%DZ edit
% Oil well Completion
 LOILP_PER = x4-x3;
if  LOILP_PER == 0 
...
OIL_PERF=num2str(Block_LOILP_PER);
N_OIL_BLOCK=num2str(N_LOILP_PER);
LOWER_OIL=num2str(BLOCK_LOWER_OIL_PER);
N_LOWER_OIL=num2str(N_LOILP_PER+N_LOWER_OIL_PER);
end
