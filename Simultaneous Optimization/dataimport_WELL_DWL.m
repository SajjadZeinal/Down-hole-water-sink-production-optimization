...
fileID=fopen('E:\Sajjad\DWS\Optimization\GA Program\Data file\Wojtanovic.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('E:\Sajjad\DWS\Optimization\GA Program\Data file\Wojtanovic.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('E:\Sajjad\DWS\Optimization\GA Program\Data file\Wojtanovic.RSM');
A=fscanf(fileID,'%c');
