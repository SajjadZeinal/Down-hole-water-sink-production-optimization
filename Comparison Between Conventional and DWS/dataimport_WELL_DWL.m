...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Comparison\DWS\150-R.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Comparison\DWS\150-R.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWS\Comparison\DWS\150-R.RSM');
A=fscanf(fileID,'%c');
