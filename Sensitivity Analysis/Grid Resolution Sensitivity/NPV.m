...
QW=int2str(Qw);
fid=fopen('H:\Univercity documents\master\Project\Work over\DWL\Simulation\DWS\Sensitivity Analysis\QWD\Data file\150-R.data','r');
...
fid=fopen('H:\Univercity documents\master\Project\Work over\DWL\Simulation\DWS\Sensitivity Analysis\QWD\Data file\150-R.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\DWL\Simulation\DWS\Sensitivity Analysis\QWD\Data file\150-R.data"');
